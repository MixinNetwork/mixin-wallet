...
class EtherAmount {
  ...
  Rational getValueInUnitRational(EtherUnit unit) =>
      Rational(_value, _factors[unit]);

  Rational get getInEther => getValueInUnitRational(EtherUnit.ether);
  ...
  @override
  String toString() => 'EtherAmount: $getInWei wei';
