...
class CollectibleToken extends Table
  ...
  late final GeneratedColumn<String> token = GeneratedColumn<String>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _mixinIdMeta =
      const VerificationMeta('mixinId');
  late final GeneratedColumn<String> mixinId = GeneratedColumn<String>(
      'mixin_id', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _nfoMeta = const VerificationMeta('nfo');
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, int> createdAt =
      GeneratedColumn<int>('created_at', aliasedName, false,
              ...
              requiredDuringInsert: true,
              $customConstraints: 'NOT NULL')
          .withConverter<DateTime>(CollectibleToken.$convertercreatedAt);
  static const VerificationMeta _metaHashMeta =
      const VerificationMeta('metaHash');
  ...
  CollectibleTokenData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CollectibleTokenData(
      ...
      mixinId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}mixin_id'])!,
      nfo: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}nfo'])!,
      createdAt: CollectibleToken.$convertercreatedAt.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])!),
      metaHash: attachedDatabase.typeMapping
...
class CollectibleTokenData extends DataClass
  ...
  CollectibleTokenData copyWithCompanion(CollectibleTokenCompanion data) {
    return CollectibleTokenData(
      type: data.type.present ? data.type.value : this.type,
      tokenId: data.tokenId.present ? data.tokenId.value : this.tokenId,
      group: data.group.present ? data.group.value : this.group,
      token: data.token.present ? data.token.value : this.token,
      mixinId: data.mixinId.present ? data.mixinId.value : this.mixinId,
      nfo: data.nfo.present ? data.nfo.value : this.nfo,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      metaHash: data.metaHash.present ? data.metaHash.value : this.metaHash,
...
class CollectibleTokenMetaData extends DataClass
  ...
  CollectibleTokenMetaData copyWithCompanion(
      CollectibleTokenMetaCompanion data) {
    return CollectibleTokenMetaData(
      group: data.group.present ? data.group.value : this.group,
...
class Collections extends Table with TableInfo<Collections, Collection> {
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, int> createdAt =
      GeneratedColumn<int>('created_at', aliasedName, false,
              ...
              requiredDuringInsert: true,
              $customConstraints: 'NOT NULL')
          .withConverter<DateTime>(Collections.$convertercreatedAt);
  @override
  List<GeneratedColumn> get $columns =>
  ...
  Collection map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Collection(
      ...
      iconUrl: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}icon_url'])!,
      createdAt: Collections.$convertercreatedAt.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])!),
    );
  }
...
class Users extends Table with TableInfo<Users, User> {
  ...
  late final GeneratedColumnWithTypeConverter<DateTime?, int> createdAt =
      GeneratedColumn<int>('created_at', aliasedName, true,
              ...
              requiredDuringInsert: false,
              $customConstraints: '')
          .withConverter<DateTime?>(Users.$convertercreatedAt);
  ...
  late final GeneratedColumnWithTypeConverter<DateTime?, int> muteUntil =
      GeneratedColumn<int>('mute_until', aliasedName, true,
              ...
              requiredDuringInsert: false,
              $customConstraints: '')
          .withConverter<DateTime?>(Users.$convertermuteUntil);
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      createdAt: Users.$convertercreatedAt.fromSql(attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])),
      muteUntil: Users.$convertermuteUntil.fromSql(attachedDatabase.typeMapping
...
class Snapshots extends Table with TableInfo<Snapshots, Snapshot> {
  ...
  late final GeneratedColumnWithTypeConverter<DateTime?, int> snapshotAt =
      GeneratedColumn<int>('snapshot_at', aliasedName, true,
              ...
              requiredDuringInsert: false,
              $customConstraints: '')
          .withConverter<DateTime?>(Snapshots.$convertersnapshotAt);
  ...
  Snapshot map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Snapshot(
      ...
      snapshotAt: Snapshots.$convertersnapshotAt.fromSql(attachedDatabase
          .typeMapping
  ...
  static TypeConverter<DateTime, int> $convertercreatedAt =
      const MillisDateConverterNotnull();
  static TypeConverter<DateTime?, int?> $convertersnapshotAt =
      const MillisDateConverter();
  @override
...
class Assets extends Table with TableInfo<Assets, Asset> {
  ...
  late final GeneratedColumn<String> reserve = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      $customConstraints: '');
  static const VerificationMeta _depositEntriesMeta =
  ...
  Asset map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Asset(
      ...
      depositEntries: attachedDatabase.typeMapping
...
class Asset extends DataClass implements Insertable<Asset> {
  ...
  Asset copyWithCompanion(AssetsCompanion data) {
    return Asset(
      ...
      depositEntries: data.depositEntries.present
          ? data.depositEntries.value
          : this.depositEntries,
    );
  }
...
class AssetsExtraData extends DataClass implements Insertable<AssetsExtraData> {
  ...
  AssetsExtraData copyWithCompanion(AssetsExtraCompanion data) {
    return AssetsExtraData(
      assetId: data.assetId.present ? data.assetId.value : this.assetId,
...
class AssetsExtraCompanion extends UpdateCompanion<AssetsExtraData> {
  ...
  AssetsExtraCompanion copyWith(
      {Value<String>? assetId, Value<bool?>? hidden, Value<int>? rowid}) {
    return AssetsExtraCompanion(
      assetId: assetId ?? this.assetId,
...
class Addresses extends Table with TableInfo<Addresses, AddressesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<String> dust = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      $customConstraints: '');
  static const VerificationMeta _feeAssetIdMeta =
      const VerificationMeta('feeAssetId');
  ...
  AddressesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AddressesData(
      ...
      feeAssetId: attachedDatabase.typeMapping
...
class AddressesData extends DataClass implements Insertable<AddressesData> {
  ...
  AddressesData copyWithCompanion(AddressesCompanion data) {
    return AddressesData(
      ...
      feeAssetId:
          data.feeAssetId.present ? data.feeAssetId.value : this.feeAssetId,
    );
  }
...
class CollectibleOutput extends Table
  ...
  late final GeneratedColumn<String> transactionHash = GeneratedColumn<String>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _outputIndexMeta =
  ...
  late final GeneratedColumn<String> amount = GeneratedColumn<String>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _sendersThresholdMeta =
  ...
  late final GeneratedColumn<int> sendersThreshold = GeneratedColumn<int>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _sendersMeta =
      const VerificationMeta('senders');
  late final GeneratedColumn<String> senders = GeneratedColumn<String>(
      'senders', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _receiversThresholdMeta =
  ...
  late final GeneratedColumn<int> receiversThreshold = GeneratedColumn<int>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _receiversMeta =
      const VerificationMeta('receivers');
  ...
  late final GeneratedColumnWithTypeConverter<DateTime, int> createdAt =
      GeneratedColumn<int>('created_at', aliasedName, false,
              ...
              requiredDuringInsert: true,
              $customConstraints: 'NOT NULL')
          .withConverter<DateTime>(CollectibleOutput.$convertercreatedAt);
  static const VerificationMeta _updatedAtMeta =
      const VerificationMeta('updatedAt');
  late final GeneratedColumnWithTypeConverter<DateTime, int> updatedAt =
      GeneratedColumn<int>('updated_at', aliasedName, false,
              ...
              requiredDuringInsert: true,
              $customConstraints: 'NOT NULL')
          .withConverter<DateTime>(CollectibleOutput.$converterupdatedAt);
  ...
  late final GeneratedColumn<String> signedBy = GeneratedColumn<String>(
      ...
      requiredDuringInsert: true,
      $customConstraints: 'NOT NULL');
  static const VerificationMeta _signedTxMeta =
      const VerificationMeta('signedTx');
  ...
  CollectibleOutputData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CollectibleOutputData(
      ...
      transactionHash: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}transaction_hash'])!,
      outputIndex: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}output_index'])!,
      amount: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}amount'])!,
      sendersThreshold: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}senders_threshold'])!,
      senders: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}senders'])!,
      receiversThreshold: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}receivers_threshold'])!,
      receivers: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}receivers'])!,
      state: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}state'])!,
      createdAt: CollectibleOutput.$convertercreatedAt.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}created_at'])!),
      updatedAt: CollectibleOutput.$converterupdatedAt.fromSql(attachedDatabase
          .typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}updated_at'])!),
      signedBy: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}signed_by'])!,
      signedTx: attachedDatabase.typeMapping
...
class CollectibleOutputData extends DataClass
  ...
  CollectibleOutputData copyWithCompanion(CollectibleOutputCompanion data) {
    return CollectibleOutputData(
      userId: data.userId.present ? data.userId.value : this.userId,
      ...
      transactionHash: data.transactionHash.present
          ...
          : this.transactionHash,
      outputIndex:
          data.outputIndex.present ? data.outputIndex.value : this.outputIndex,
      amount: data.amount.present ? data.amount.value : this.amount,
      sendersThreshold: data.sendersThreshold.present
          ? data.sendersThreshold.value
          : this.sendersThreshold,
      senders: data.senders.present ? data.senders.value : this.senders,
      receiversThreshold: data.receiversThreshold.present
          ? data.receiversThreshold.value
          : this.receiversThreshold,
      receivers: data.receivers.present ? data.receivers.value : this.receivers,
      state: data.state.present ? data.state.value : this.state,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      signedBy: data.signedBy.present ? data.signedBy.value : this.signedBy,
      signedTx: data.signedTx.present ? data.signedTx.value : this.signedTx,
    );
  }
...
typedef $CollectibleTokenCreateCompanionBuilder = CollectibleTokenCompanion
    Function({
  required String type,
  required String tokenId,
  required String group,
...
typedef $CollectibleTokenUpdateCompanionBuilder = CollectibleTokenCompanion
    Function({
  Value<String> type,
  Value<String> tokenId,
  Value<String> group,
...
class $CollectibleTokenFilterComposer
    extends Composer<_$MixinDatabase, CollectibleToken> {
  $CollectibleTokenFilterComposer({
    required super.$db,
  ...
  ColumnFilters<String> get mixinId => $composableBuilder(
      column: $table.mixinId, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get nfo => $composableBuilder(
      column: $table.nfo, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get metaHash => $composableBuilder(
      column: $table.metaHash, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get collectionId => $composableBuilder(
      column: $table.collectionId, builder: (column) => ColumnFilters(column));
}

class $CollectibleTokenOrderingComposer
    extends Composer<_$MixinDatabase, CollectibleToken> {
  $CollectibleTokenOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get mixinId => $composableBuilder(
      column: $table.mixinId, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get nfo => $composableBuilder(
      column: $table.nfo, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get createdAt => $composableBuilder(
      column: $table.createdAt, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get metaHash => $composableBuilder(
      column: $table.metaHash, builder: (column) => ColumnOrderings(column));
...
class $CollectibleTokenAnnotationComposer
    extends Composer<_$MixinDatabase, CollectibleToken> {
  $CollectibleTokenAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get mixinId =>
      $composableBuilder(column: $table.mixinId, builder: (column) => column);

  GeneratedColumn<String> get nfo =>
      $composableBuilder(column: $table.nfo, builder: (column) => column);

  GeneratedColumnWithTypeConverter<DateTime, int> get createdAt =>
      $composableBuilder(column: $table.createdAt, builder: (column) => column);

  GeneratedColumn<String> get metaHash =>
      $composableBuilder(column: $table.metaHash, builder: (column) => column);

  GeneratedColumn<String> get collectionId => $composableBuilder(
      column: $table.collectionId, builder: (column) => column);
}

class $CollectibleTokenTableManager extends RootTableManager<
    _$MixinDatabase,
    CollectibleToken,
    CollectibleTokenData,
    $CollectibleTokenFilterComposer,
    $CollectibleTokenOrderingComposer,
    $CollectibleTokenAnnotationComposer,
    $CollectibleTokenCreateCompanionBuilder,
    $CollectibleTokenUpdateCompanionBuilder,
    (
      CollectibleTokenData,
      BaseReferences<_$MixinDatabase, CollectibleToken, CollectibleTokenData>
    ),
    CollectibleTokenData,
    PrefetchHooks Function()> {
  $CollectibleTokenTableManager(_$MixinDatabase db, CollectibleToken table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $CollectibleTokenFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $CollectibleTokenOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $CollectibleTokenAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> type = const Value.absent(),
            Value<String> tokenId = const Value.absent(),
            Value<String> group = const Value.absent(),
            Value<String> token = const Value.absent(),
            Value<String> mixinId = const Value.absent(),
            Value<String> nfo = const Value.absent(),
            Value<DateTime> createdAt = const Value.absent(),
            Value<String> metaHash = const Value.absent(),
            Value<String> collectionId = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              CollectibleTokenCompanion(
            type: type,
            tokenId: tokenId,
            group: group,
            token: token,
...
typedef $CollectibleTokenProcessedTableManager = ProcessedTableManager<
    _$MixinDatabase,
    CollectibleToken,
    CollectibleTokenData,
    $CollectibleTokenFilterComposer,
    ...
    CollectibleTokenData,
    PrefetchHooks Function()>;
typedef $CollectibleTokenMetaCreateCompanionBuilder
    = CollectibleTokenMetaCompanion Function({
  required String group,
  required String name,
  required String description,
  required String iconUrl,
...
typedef $CollectibleTokenMetaUpdateCompanionBuilder
    = CollectibleTokenMetaCompanion Function({
  Value<String> group,
  Value<String> name,
  Value<String> description,
...
class $CollectibleTokenMetaFilterComposer
    extends Composer<_$MixinDatabase, CollectibleTokenMeta> {
  $CollectibleTokenMetaFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $CollectibleTokenMetaOrderingComposer
    extends Composer<_$MixinDatabase, CollectibleTokenMeta> {
  $CollectibleTokenMetaOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $CollectibleTokenMetaAnnotationComposer
    extends Composer<_$MixinDatabase, CollectibleTokenMeta> {
  $CollectibleTokenMetaAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $CollectibleTokenMetaTableManager extends RootTableManager<
    _$MixinDatabase,
    CollectibleTokenMeta,
    CollectibleTokenMetaData,
    $CollectibleTokenMetaFilterComposer,
    $CollectibleTokenMetaOrderingComposer,
    $CollectibleTokenMetaAnnotationComposer,
    $CollectibleTokenMetaCreateCompanionBuilder,
    $CollectibleTokenMetaUpdateCompanionBuilder,
    (
      CollectibleTokenMetaData,
      BaseReferences<_$MixinDatabase, CollectibleTokenMeta,
          CollectibleTokenMetaData>
    ),
    CollectibleTokenMetaData,
    PrefetchHooks Function()> {
  $CollectibleTokenMetaTableManager(
      _$MixinDatabase db, CollectibleTokenMeta table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $CollectibleTokenMetaFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $CollectibleTokenMetaOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $CollectibleTokenMetaAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> group = const Value.absent(),
...
typedef $CollectibleTokenMetaProcessedTableManager = ProcessedTableManager<
    _$MixinDatabase,
    CollectibleTokenMeta,
    CollectibleTokenMetaData,
    $CollectibleTokenMetaFilterComposer,
...
class $CollectionsFilterComposer
    extends Composer<_$MixinDatabase, Collections> {
...
class $CollectionsTableManager extends RootTableManager<
    _$MixinDatabase,
    Collections,
    Collection,
    $CollectionsFilterComposer,
    ...
    (Collection, BaseReferences<_$MixinDatabase, Collections, Collection>),
    Collection,
    PrefetchHooks Function()> {
  $CollectionsTableManager(_$MixinDatabase db, Collections table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $CollectionsProcessedTableManager = ProcessedTableManager<
    _$MixinDatabase,
    Collections,
    Collection,
    $CollectionsFilterComposer,
...
class $SnapshotsFilterComposer extends Composer<_$MixinDatabase, Snapshots> {
  ...
  ColumnWithTypeConverterFilters<DateTime?, DateTime, int> get snapshotAt =>
      $composableBuilder(
...
class $SnapshotsAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<DateTime?, int> get snapshotAt =>
      $composableBuilder(
...
class $AssetsFilterComposer extends Composer<_$MixinDatabase, Assets> {
  ...
  ColumnFilters<String> get depositEntries => $composableBuilder(
      column: $table.depositEntries,
      builder: (column) => ColumnFilters(column));
}
...
class $AssetsOrderingComposer extends Composer<_$MixinDatabase, Assets> {
  ...
  ColumnOrderings<String> get depositEntries => $composableBuilder(
      column: $table.depositEntries,
      builder: (column) => ColumnOrderings(column));
}
...
class $AssetsAnnotationComposer extends Composer<_$MixinDatabase, Assets> {
  ...
  GeneratedColumn<String> get depositEntries => $composableBuilder(
      column: $table.depositEntries, builder: (column) => column);
}
...
typedef $ChainsProcessedTableManager = ProcessedTableManager<
    ...
    Chain,
    PrefetchHooks Function()>;
typedef $AssetsExtraCreateCompanionBuilder = AssetsExtraCompanion Function({
  required String assetId,
  Value<bool?> hidden,
  Value<int> rowid,
});
typedef $AssetsExtraUpdateCompanionBuilder = AssetsExtraCompanion Function({
  Value<String> assetId,
  Value<bool?> hidden,
  Value<int> rowid,
});

class $AssetsExtraFilterComposer
    extends Composer<_$MixinDatabase, AssetsExtra> {
  $AssetsExtraFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $AssetsExtraOrderingComposer
    extends Composer<_$MixinDatabase, AssetsExtra> {
  $AssetsExtraOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $AssetsExtraAnnotationComposer
    extends Composer<_$MixinDatabase, AssetsExtra> {
  $AssetsExtraAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $AssetsExtraTableManager extends RootTableManager<
    _$MixinDatabase,
    AssetsExtra,
    AssetsExtraData,
    $AssetsExtraFilterComposer,
    $AssetsExtraOrderingComposer,
    $AssetsExtraAnnotationComposer,
    $AssetsExtraCreateCompanionBuilder,
    $AssetsExtraUpdateCompanionBuilder,
    (
      AssetsExtraData,
      BaseReferences<_$MixinDatabase, AssetsExtra, AssetsExtraData>
    ),
    AssetsExtraData,
    PrefetchHooks Function()> {
  $AssetsExtraTableManager(_$MixinDatabase db, AssetsExtra table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $AssetsExtraFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $AssetsExtraOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $AssetsExtraAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> assetId = const Value.absent(),
            Value<bool?> hidden = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              AssetsExtraCompanion(
            assetId: assetId,
            hidden: hidden,
            rowid: rowid,
          ),
...
typedef $AssetsExtraProcessedTableManager = ProcessedTableManager<
    _$MixinDatabase,
    AssetsExtra,
    AssetsExtraData,
    $AssetsExtraFilterComposer,
...
class $AddressesFilterComposer extends Composer<_$MixinDatabase, Addresses> {
  ...
  ColumnFilters<String> get feeAssetId => $composableBuilder(
      column: $table.feeAssetId, builder: (column) => ColumnFilters(column));
}
...
class $AddressesOrderingComposer extends Composer<_$MixinDatabase, Addresses> {
  ...
  ColumnOrderings<String> get feeAssetId => $composableBuilder(
      column: $table.feeAssetId, builder: (column) => ColumnOrderings(column));
}
...
class $AddressesAnnotationComposer
  ...
  GeneratedColumn<String> get feeAssetId => $composableBuilder(
      column: $table.feeAssetId, builder: (column) => column);
}
...
class $AddressesTableManager extends RootTableManager<
    ...
    (AddressesData, BaseReferences<_$MixinDatabase, Addresses, AddressesData>),
    AddressesData,
    PrefetchHooks Function()> {
  $AddressesTableManager(_$MixinDatabase db, Addresses table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String?> tag = const Value.absent(),
            Value<String?> dust = const Value.absent(),
            Value<String> feeAssetId = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              AddressesCompanion(
            addressId: addressId,
...
typedef $AddressesProcessedTableManager = ProcessedTableManager<
    ...
    AddressesData,
    PrefetchHooks Function()>;
typedef $CollectibleOutputCreateCompanionBuilder = CollectibleOutputCompanion
    Function({
  required String userId,
  required String outputId,
  required String tokenId,
...
typedef $CollectibleOutputUpdateCompanionBuilder = CollectibleOutputCompanion
    Function({
  Value<String> userId,
  Value<String> outputId,
  Value<String> tokenId,
...
class $CollectibleOutputFilterComposer
    extends Composer<_$MixinDatabase, CollectibleOutput> {
  $CollectibleOutputFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<int> get outputIndex => $composableBuilder(
      column: $table.outputIndex, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get amount => $composableBuilder(
      column: $table.amount, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get sendersThreshold => $composableBuilder(
      column: $table.sendersThreshold,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get senders => $composableBuilder(
      column: $table.senders, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get receiversThreshold => $composableBuilder(
      column: $table.receiversThreshold,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get receivers => $composableBuilder(
      column: $table.receivers, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get signedTx => $composableBuilder(
      column: $table.signedTx, builder: (column) => ColumnFilters(column));
}

class $CollectibleOutputOrderingComposer
    extends Composer<_$MixinDatabase, CollectibleOutput> {
  $CollectibleOutputOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<int> get outputIndex => $composableBuilder(
      column: $table.outputIndex, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get amount => $composableBuilder(
      column: $table.amount, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get sendersThreshold => $composableBuilder(
      column: $table.sendersThreshold,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get senders => $composableBuilder(
      column: $table.senders, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get receiversThreshold => $composableBuilder(
      column: $table.receiversThreshold,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get receivers => $composableBuilder(
      column: $table.receivers, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get signedTx => $composableBuilder(
      column: $table.signedTx, builder: (column) => ColumnOrderings(column));
}

class $CollectibleOutputAnnotationComposer
    extends Composer<_$MixinDatabase, CollectibleOutput> {
  $CollectibleOutputAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<int> get outputIndex => $composableBuilder(
      column: $table.outputIndex, builder: (column) => column);

  GeneratedColumn<String> get amount =>
      $composableBuilder(column: $table.amount, builder: (column) => column);

  GeneratedColumn<int> get sendersThreshold => $composableBuilder(
      column: $table.sendersThreshold, builder: (column) => column);

  GeneratedColumn<String> get senders =>
      $composableBuilder(column: $table.senders, builder: (column) => column);

  GeneratedColumn<int> get receiversThreshold => $composableBuilder(
      column: $table.receiversThreshold, builder: (column) => column);

  GeneratedColumn<String> get receivers =>
      $composableBuilder(column: $table.receivers, builder: (column) => column);
  ...
  GeneratedColumn<String> get signedTx =>
      $composableBuilder(column: $table.signedTx, builder: (column) => column);
}

class $CollectibleOutputTableManager extends RootTableManager<
    _$MixinDatabase,
    CollectibleOutput,
    CollectibleOutputData,
    $CollectibleOutputFilterComposer,
    $CollectibleOutputOrderingComposer,
    $CollectibleOutputAnnotationComposer,
    $CollectibleOutputCreateCompanionBuilder,
    $CollectibleOutputUpdateCompanionBuilder,
    (
      CollectibleOutputData,
      BaseReferences<_$MixinDatabase, CollectibleOutput, CollectibleOutputData>
    ),
    CollectibleOutputData,
    PrefetchHooks Function()> {
  $CollectibleOutputTableManager(_$MixinDatabase db, CollectibleOutput table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $CollectibleOutputFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $CollectibleOutputOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $CollectibleOutputAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> userId = const Value.absent(),
            Value<String> outputId = const Value.absent(),
            Value<String> tokenId = const Value.absent(),
            Value<String> transactionHash = const Value.absent(),
            Value<int> outputIndex = const Value.absent(),
            Value<String> amount = const Value.absent(),
            Value<int> sendersThreshold = const Value.absent(),
            Value<String> senders = const Value.absent(),
            Value<int> receiversThreshold = const Value.absent(),
            Value<String> receivers = const Value.absent(),
            Value<String> state = const Value.absent(),
            Value<DateTime> createdAt = const Value.absent(),
            Value<DateTime> updatedAt = const Value.absent(),
            Value<String> signedBy = const Value.absent(),
            Value<String> signedTx = const Value.absent(),
            Value<int> rowid = const Value.absent(),
          }) =>
              CollectibleOutputCompanion(
            userId: userId,
            outputId: outputId,
            tokenId: tokenId,
            transactionHash: transactionHash,
            ...
            senders: senders,
            receiversThreshold: receiversThreshold,
            receivers: receivers,
            state: state,
            createdAt: createdAt,
            updatedAt: updatedAt,
...
typedef $CollectibleOutputProcessedTableManager = ProcessedTableManager<
    _$MixinDatabase,
    CollectibleOutput,
    CollectibleOutputData,
    $CollectibleOutputFilterComposer,
...
class $MixinDatabaseManager {
  ...
  $CollectibleTokenTableManager get collectibleToken =>
      $CollectibleTokenTableManager(_db, _db.collectibleToken);
  $CollectibleTokenMetaTableManager get collectibleTokenMeta =>
      $CollectibleTokenMetaTableManager(_db, _db.collectibleTokenMeta);
  ...
  $AssetsExtraTableManager get assetsExtra =>
      $AssetsExtraTableManager(_db, _db.assetsExtra);
  ...
  $CollectibleOutputTableManager get collectibleOutput =>
      $CollectibleOutputTableManager(_db, _db.collectibleOutput);
}
